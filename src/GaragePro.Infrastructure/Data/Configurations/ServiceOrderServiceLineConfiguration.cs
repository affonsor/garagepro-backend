...
public class ServiceOrderServiceLineConfiguration : IEntityTypeConfiguration<ServiceOrderServiceLine>
{
    public void Configure(EntityTypeBuilder<ServiceOrderServiceLine> builder)
    {
        builder.HasKey(l => l.Id);
        builder.Property(l => l.Id).ValueGeneratedNever();
        builder.Property(l => l.ServiceName).IsRequired().HasMaxLength(200);
        ...
        builder.HasOne(l => l.Service)
            .WithMany(s => s.ServiceOrderServiceLines)
